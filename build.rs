...
fn build_and_link_mlx_c() {
    let mut config = Config::new("third_party/mlx-c");
...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .header("third_party/mlx-c/mlx/c/mlx.h")
        .header("third_party/mlx-c/mlx/c/linalg.h")
        .header("third_party/mlx-c/mlx/c/error.h")
        .header("third_party/mlx-c/mlx/c/transforms_impl.h")
        .clang_arg("-Ithird_party/mlx-c")
